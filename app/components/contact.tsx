        ...
        <div className="container mx-auto px-6">
          ...
          <div className="max-w-md mx-auto">
            <form className="space-y-4">
              ...
              <button type="submit" className="w-full bg-indigo-600 text-white py-2 px-4 rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-opacity-50">Send Message</button>
            </form>
          </div>
        </div>
      </section>
